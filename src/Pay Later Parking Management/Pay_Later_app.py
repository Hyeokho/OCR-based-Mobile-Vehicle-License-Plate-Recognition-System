...
def next_info():
	...
	if dev_mysql.search_car_num_from_member(str.get()) == None and dev_mysql.search_car_num_from_session(str.get()) == None:
		...
		if dev_mysql.search_car_num_from_member(str.get()) != None:
			...
			notice_label=Label(root,padx=5,pady=5,width=39,bg='white',fg='dark violet',bd=0,relief=GROOVE,text='회원차량 입니다',font=('helvetica 15 bold'))
...
def save_info(choice):
	...
	if choice == 1:
		...
		if myname.get() == '':
			...
			save_form=Label(root,padx=5,pady=5,width=39,bg='SkyBlue2',fg='white',bd=0,relief=GROOVE,text='입차\n되었습니다',font=('helvetica 15 bold'))
			save_form.place(x=0,y=170)
...
def gohome():
   ...
   but4.place(x=150,y=210)
   but3.place(x=340,y=500)
   but5.place(x=0,y=270)
   comming.place(x=0,y=335)
...
but2=Button(frame,padx=5,pady=5,width=26,bg='dim gray',fg='white',bd=0,relief=GROOVE,command=lambda:capture(2),text='입차',font=('helvetica 15 bold'))
but2.place(x=150,y=130)

but4=Button(frame,padx=5,pady=5,width=26,bg='dim gray',fg='white',bd=0,relief=GROOVE,command=lambda:capture(3),text='출차',font=('helvetica 15 bold'))
but4.place(x=150,y=210)
...
but5=Button(frame,padx=5,pady=5,width=39,bg='skyblue',fg='white',bd=0,relief=GROOVE,command=manage,text='회원 정보 관리',font=('helvetica 15 bold'))
but5.place(x=0,y=270)
...
comming=Button(frame,padx=5,pady=5,width=39,bg='slate gray',fg='white',bd=0,relief=GROOVE,text='Comming soon!!',font=('helvetica 15 bold'))
comming.place(x=0,y=335)
